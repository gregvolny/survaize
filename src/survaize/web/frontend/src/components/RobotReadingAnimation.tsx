...
const RobotReadingAnimation = ({ width = 300, height = 240, className = "" }) => {
  return (
    <svg 
      width={width} 
      height={height} 
    ...
    >
      <defs>
        ...
        <linearGradient id="handleGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" style={{stopColor:"#AA0000", stopOpacity:1}} />
        </linearGradient>
      ...
      <g id="robotBounce">
        ...
        {/* Arms */}
        <line x1="-10" y1="80" x2="5" y2="70" stroke="#2f66f3" strokeWidth="6" strokeLinecap="round" />
        <line x1="70" y1="80" x2="55" y2="70" stroke="#2f66f3" strokeWidth="6" strokeLinecap="round" />
        ...
        {/* Smile & Eyebrows */}
        <path d="M22 35 Q30 42 38 35" stroke="#333" strokeWidth="2" fill="none" />
        <line x1="15" y1="18" x2="25" y2="16" stroke="#333" strokeWidth="2" strokeLinecap="round" />
        <line x1="35" y1="16" x2="45" y2="18" stroke="#333" strokeWidth="2" strokeLinecap="round" />
